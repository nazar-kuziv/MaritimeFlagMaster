...
class MainMenu(Util.AppPage):
    ...
    def main_menu(self):
        ...
        commands = [lambda: Util.new_page(OptionsMenu, "Flashcards", master=self.window, next_page=Flashcards, questions_number_choices=[0, 5, 10, 20], questions_number_def_ind=0, time_minutes_choices=[0, 1, 2, 5, 10],  time_minutes_def_ind=0),
